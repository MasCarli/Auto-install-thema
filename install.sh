...
display_welcome() {
  ...
  echo -e "${BLUE}[+]                  © ᴍᴀsᴄᴀʀʟɪ ᴏғғɪᴄɪᴀʟ               [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${RED}[+] =============================================== [+]${NC}"
  echo -e ""
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSE MasCarli            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "MasCarli" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Token Salah! Beli Kode Token Di BANG Carli${NC}"
    echo -e "${YELLOW}TELEGRAM : t.me/MasCarli${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}© ᴍᴀsᴄᴀʀʟɪ ᴏғғɪᴄɪᴀʟ${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Credit  : MasCarli Store      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Telegram  : t.me/MasCarlii  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp        
